# Generated by Powerlevel10k configuration wizard on 2025-10-21 at 21:45 +04.
...
() {
  ...
  # Keep the active right prompt focused on tools used in this environment.
  # This overrides the wizard's exhaustive compatibility list above without
  # disturbing the generated color and layout settings below.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    status
